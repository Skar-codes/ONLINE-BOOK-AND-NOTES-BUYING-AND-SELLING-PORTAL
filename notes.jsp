 ...
 <hr class = "redline">
  <div class="buy-view">
	    		    <form  action="notes.jsp">
	    		    	...
	    		    	{
	    		    	%>
	    		    			<a href="notes.jsp?myNotes=true" id="MyBooks">My Notes</a>
    			   ...
    			   <div class="booksview">
	    			  <div class="book-list">
				        <%
				            ...
				            if(searchQuery != null)
				            	 query = "SELECT * FROM books WHERE category = ? and book_name LIKE ?";
				            else if (("admin".equals(role) == false) && (myNotes != null && myNotes.equals("true"))) {
				            	query = "SELECT * FROM books WHERE category = ? and seller_id = ?";
				        	}
				            else
				            	 query = "SELECT * FROM books WHERE category = ? AND seller_id NOT IN(?)";
				           ...
				           // out.println("<h3>Search results for: " + searchQuery + "</h3>");
				            try {
				            	Connection con = DbConnection.getConnection();
				    	     	...
				    	     	else if (myNotes != null && myNotes.equals("true")) 
				    	     		 ps.setInt(2, UserId); 
				    	     	else 
				    	     		ps.setInt(2, UserId);
